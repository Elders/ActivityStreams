...
//        readonly StreamFactory feedFactory;

//        public GGFactory(IActivityRepository activityRepository, StreamFactory feedFactory)
//        {
//            this.activityRepository = activityRepository;
//            this.feedFactory = feedFactory;
//        }

//        public IStream GetFeed(int numberOfStreams, int activitiesPerStream)
//        {
...
//                    feed.Attach(streamId.ToByteArray());
